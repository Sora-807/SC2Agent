...
> 配套文档：docs/ISSUES.md（问题清单）、docs/WORKLOG.md（执行史）；历史计划见 docs/archive/
>（⚠️ 本文件 REV/队列语义等局部过时待刷新：队列账本以 ADR-0032 为准、supply_guard 以 ADR-0034 为准、
> app.py 已拆 routes/、当前基线 1034 后端 / 409 前端）。
